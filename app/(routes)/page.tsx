...
import { PopularCategoriesList } from "@/components/main-page/popular-categories-list";
import { PlantCareEssential } from "@/components/main-page/plant-care-essentials";
import { NewReleasesSection } from "@/components/main-page/new-releases-section";
import { PlantOfTheMonthSection } from "@/components/main-page/plant-of-month-section";
import { CareSliderSection } from "@/components/main-page/care-slider-section";
import getProductsForCareSlider from "@/actions/get-products-for-care-slider";
import { CommunitySlider } from "@/components/main-page/community-slider-section";
import { ReviewSliderSection } from "@/components/main-page/review-slider-section";
import { BabyPlantSection } from "@/components/main-page/baby-plant-section/baby-plant-section";
import { RarePlantSection } from "@/components/main-page/rare-plant-section/rare-plant-section";
import { JourneySliderSection } from "@/components/main-page/journey-slider-section";
import { PopupInfoSection } from "@/components/main-page/popup-info-section";
