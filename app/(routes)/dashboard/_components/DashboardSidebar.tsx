...
import { Home, User, Car, Heart, BellRing, Settings, LogOut, BoxIcon } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      >       
        ...
        <MenuItem href='/dashboard/perchased-products' icon={<BoxIcon size={18}/>}>My perchased goods</MenuItem>
